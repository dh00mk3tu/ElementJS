...
(function(w) {
    ...
    */
    var canvas_width = 700; //Needs to be a multiple of the resolution value below.
    var canvas_height = 700; //This too.
    ...
    */
    function mouse_down_handler(e) {
        ...
        status =  "mouse down-";
        document.getElementById("status").innerHTML = status + mouse.down;
    ...
    function touch_start_handler(e) {
        ...
        mouse.down = true; //Sets the mouse object's "down" value to true
        status =  "mouse touch start-";
        document.getElementById("status").innerHTML = status + mouse.down + "[" + mouse.x+","+mouse.y+"]";
    }
    ...
    */
    function mouse_move_handler(e) {
        ...
        status =  "mouse move-";
        document.getElementById("status").innerHTML = status + "[" + mouse.x+","+mouse.y+"]";
